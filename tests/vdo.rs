use usb_mess::vdo::{
    decode_cable_vdo, decode_id_header, parse_vdo_hex, CableCurrent, CableSpeed, ProductType,
};
...
fn id_header_apple_passive_cable() {
    ...
    assert!(matches!(
        v.product_type_cable,
        Some(ProductType::PassiveCable)
    ));
}
...
fn cable_vdo_passive_usb32_gen2_3a() {
    ...
    let raw = 0b011u32        // USB Signaling = USB 3.2 Gen2
